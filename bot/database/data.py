...
def create_db():
    ...
    :return: None
    """
    with sqlite3.connect('machines.db') as conn:
        cur = conn.cursor()
...
def insert_machine(line_name: str, model: str, image_path: bool, description: str):
    ...
    :return:
    """
    conn = sqlite3.connect('/Users/admin/PycharmProjects/Emag_bot/bot/machines.db')
    cursor = conn.cursor()
...
async def select_machines_by_line_and_model(line_name, model):
    ...
    :return:
    """
    async with aiosqlite.connect('/Users/admin/PycharmProjects/Emag_bot/bot/machines.db') as db:
