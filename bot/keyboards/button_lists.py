...
coupling = ["ОТТМ", "БАТРЕСС", "CENTUM", "в меню =>>"]
pipe_thread = ["ОТТМ", "ОТТМ", "CENTUM", "в меню =>>"]
bearings = ["Кольцо под подшипник", "в меню =>>"]
hub = ["Ступица1", "в меню =>>"]
...
details_list = ["ОТТМ", "БАТРЕСС", "CENTUM", "Кольцо под подшипник", "Ступица1"]